...
class PotentialEvapotranspiration(Component):
    ...
    **Additional References**
    ...
    def __init__(
        ...
        self._zd = Zd
        self._zo = Zo
        self._zveg = self._validate_zveg(Zveg)
        self._vz = Vwind
        self._rl = self._validate_rl(Rl)
    ...
    def _validate_zveg(self, zveg):
        return self._process_field(zveg, "vegetation_height")

    def _validate_rl(self, rl):
        return self._process_field(rl, "leaf_resistance")
    ...
    def _UpdateRad(self):
        ...
        self._zveg = self._validate_zveg(self._zveg)
        self._rl = self._validate_rl(self._rl)
